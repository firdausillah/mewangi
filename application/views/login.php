          ...
          <div class="card-body">
            ...
            <form id="formAuthentication" class="mb-3" action="<?= base_url('login/auth') ?>" method="POST">
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="username" name="username" placeholder="Masukan username / email" autofocus />
              </div>
              ...
              <div class="mb-3 d-flex flex-column gap-3">
                ...
                <a class="btn btn-outline-primary d-grid w-100" href="<?= base_url() ?>">Halaman Utama</a>
              </div>
            </form>
