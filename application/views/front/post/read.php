                ...
                <section id="blog-author" class="blog-author section">
                    ...
                    <div class="container">
                        <div class="author-container d-flex align-items-center">
                            <img src="<?= base_url() ?>assets/front/img/blog/blog-author.jpg" class="rounded-circle flex-shrink-0" alt="">
                            <div>
                                <h4>Jane Smith</h4>
                ...
                <section id="blog-comments" class="blog-comments section">
                    ...
                    <div class="container">
                        ...
                        <div id="comment-1" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="<?= base_url() ?>assets/front/img/blog/comments-1.jpg" alt=""></div>
                                <div>
                        ...
                        <div id="comment-2" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="<?= base_url() ?>assets/front/img/blog/comments-2.jpg" alt=""></div>
                                <div>
                            ...
                            <div id="comment-reply-1" class="comment comment-reply">
                                <div class="d-flex">
                                    <div class="comment-img"><img src="<?= base_url() ?>assets/front/img/blog/comments-3.jpg" alt=""></div>
                                    <div>
                                ...
                                <div id="comment-reply-2" class="comment comment-reply">
                                    <div class="d-flex">
                                        <div class="comment-img"><img src="<?= base_url() ?>assets/front/img/blog/comments-4.jpg" alt=""></div>
                                        <div>
                        ...
                        <div id="comment-3" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="<?= base_url() ?>assets/front/img/blog/comments-5.jpg" alt=""></div>
                                <div>
                        ...
                        <div id="comment-4" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="<?= base_url() ?>assets/front/img/blog/comments-6.jpg" alt=""></div>
                                <div>
