<div class="card p-3">
    <div class="d-flex justify-content-between">
        ...
        <a href="<?= base_url('admin/user?page=add') ?>" class="btn btn-sm btn-success my-auto">Tambah data</a>
                ...
                <?php foreach ($user as $index => $item) : ?>
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="text-danger" href="#" onclick="confirmDelete('<?= base_url('admin/user/delete/' . $item->id) ?>')"><i class="bx bx-trash me-1"></i></a>
                        </td>
                    </tr>
                <?php endforeach ?>
            </tbody>
