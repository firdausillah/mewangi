...
<head>
	...
	<link rel="shortcut icon" href="<?= base_url() ?>assets/img/aruna-logo-gram.png" />
	...
	<div class="wrapper">
		...
		<div class="main">
			<nav class="navbar navbar-expand-lg navbar-dark-blue bg-dark-blue fixed-top">
				<div class="container">
					<a class="navbar-brand" href="#"> <img src="<?= base_url() ?>assets/img/aruna-logo-gram.png" height="30px" alt="" class="mr-1"> <span><?= $profile->nama_sekolah ?></span></a>
