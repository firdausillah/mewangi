...
<head>
  ...
  <title>Homepage | <?= $profile ? $profile->nama_sekolah : 'Aruna Homepage' ?>></title>
...
<body class="index-page">
  ...
  <main class="main">
      ...
      <div class="container">
        ...
        <div class="row g-0">
          ...
          <div class="col-xl-5 img-bg" data-aos="fade-up" data-aos-delay="100">
            <img src="<?= base_url() ?>assets/front/img/why-us-bg.jpg" alt="">
          </div>
    ...
    <section id="call-to-action" class="call-to-action section dark-background">
      ...
      <img src="<?= base_url() ?>assets/front/img/cta-bg.jpg" alt="">
        ...
        <div class="row">
          ...
          <div class="col-lg-5 position-relative" data-aos="zoom-out" data-aos-delay="200">
            <div class="phone-wrap">
              <img src="<?= base_url() ?>assets/front/img/iphone.png" alt="Image" class="img-fluid">
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row gy-5">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="200">
            <div class="post-box">
              <div class="post-img"><img src="<?= base_url() ?>assets/front/img/blog/blog-1.jpg" class="img-fluid" alt=""></div>
              <div class="meta">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="400">
            <div class="post-box">
              <div class="post-img"><img src="<?= base_url() ?>assets/front/img/blog/blog-2.jpg" class="img-fluid" alt=""></div>
              <div class="meta">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="post-box">
              <div class="post-img"><img src="<?= base_url() ?>assets/front/img/blog/blog-3.jpg" class="img-fluid" alt=""></div>
              <div class="meta">
          ...
          <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="600">
            <div class="post-box">
              <div class="post-img"><img src="<?= base_url() ?>assets/front/img/blog/blog-4.jpg" class="img-fluid" alt=""></div>
              <div class="meta">
